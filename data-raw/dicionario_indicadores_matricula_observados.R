...
dicionario_indicadores_matricula_observados <- data.frame(
  ...
  descricao = c(
    ...
    "Faixa etaria analisada.",
    "Codigo da etapa de ensino adequada a faixa etaria.",
    "Nome da etapa de ensino adequada a faixa etaria.",
    "Total de matriculas na etapa de ensino adequada.",
    "Matriculas da faixa etaria na etapa de ensino adequada.",
    "Matriculas fora da faixa etaria adequada na etapa de ensino adequada.",
    "Total amplo de matriculas na faixa etaria analisada, sem recorte por etapa.",
  ...
  fonte_dados = c(
    rep("Chaves de identificacao das bases de origem", 6),
  ...
  tabela_origem = c(
    rep("Bases de matriculas por etapa e populacao por faixa etaria adequada", 6),
  ...
  observacao = c(
    ...
    "",
    "",
    "Valores esperados: 0 a 3 anos, 4 a 5 anos, 6 a 10 anos, 11 a 14 anos, 15 a 17 anos ou 18 a 19 anos.",
    "Valores esperados: CRE, PRE, AI, AF, EM ou POS_EM.",
    "",
