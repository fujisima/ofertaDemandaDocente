...
As funções de leitura `ler_matricula_faixaetaria()`,
...
Defina metas gerais por faixa etária. A faixa `18 a 19 anos` deve ter apenas
meta de taxa bruta, pois nao possui taxa liquida:
...
Em seguida, componha a tabela final de matrículas por etapa de ensino:
...
Para consultar uma UF em formato wide:
